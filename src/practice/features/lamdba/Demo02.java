...
public class Demo02 {
    public static void main(String[] args) {
        ...
        // lambda 优化
        int sum2 = calculateNum((int left, int right) -> left + right, 10, 20);
        ...
        // 现在我们要实现这个方法.
        // 这段代码其实就是匿名内部类的写法
        int sum3 = calculateNum(Integer::sum, 10, 20);
        System.out.println("引用方法写法:" + sum3);

        int sum4 = ((IntBinaryOperator) (left, right) -> left + right).applyAsInt(10, 25);
